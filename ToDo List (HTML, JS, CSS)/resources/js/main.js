...
function renderToDoList() {
	...
	for(var i in data.completed){
		addItemTodo(data.completed[i], true);
	}
}
...
function addItemTodo(text, completed) {
	var list = (completed) ? document.getElementById('completed'): document.getElementById('incomplete');
...
function completeItem(e) {
	...
	if(id == 'incomplete') {
		...
		newList = document.getElementById('completed')
